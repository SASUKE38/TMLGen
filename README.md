...
7. Locate the generated source and scene files in your mod's Public\mod name\Timeline\Generated folder.
8. Replace these files with the originals from the unpacked game data. If necessary, rename the originals so they have the same name as the files you replace.
9. Locate the .tml file generated by the editor in your mod's Editor\Mods\mod name\Timeline\Generated directory.
